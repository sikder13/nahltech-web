...
A September 2026 follow-up applies the same lens to the Gulf: [Readable but Unreachable](/research/gulf-smb-websites-ai-search-study).
...
This dataset is published under the [Creative Commons Attribution 4.0 license](https://creativecommons.org/licenses/by/4.0/). Quote it, chart it, or republish it, with credit to Nahl Technologies and a link to this page.
