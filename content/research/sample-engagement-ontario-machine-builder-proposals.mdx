...
*Want this measurement run on your proposal process? Start with the [free 30-minute scan](/pricing), or start with [how a full audit runs, number by number](/blog/ai-opportunity-audit-worked-example).*
